...
# Dashboard Preview
<img width="900" height="400" alt="image" src="https://github.com/user-attachments/assets/44213796-26af-40fb-8ced-14a6ab15b4b5" />
...
Risk Score = (1 - normalize(PV.EST))  × 0.35 + (1 - normalize(GE.EST))  × 0.25 + (1 - normalize(LPI)) × 0.30 + normalize(Inflation Volatility) × 0.10
